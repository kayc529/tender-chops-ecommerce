...
import com.kaycheung.order_service.exception.domain.quote.QuoteException;
...
public class QuoteExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(QuoteExceptionHandler.class);

    @ExceptionHandler(QuoteException.class)
    public ResponseEntity<ApiErrorResponse> handleQuoteException(QuoteException ex, HttpServletRequest request) {
        log.warn("QuoteException: status={}, code={}, path={}, msg={}",
