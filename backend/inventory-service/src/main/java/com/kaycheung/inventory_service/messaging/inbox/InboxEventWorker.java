...
import com.kaycheung.inventory_service.config.properties.MessagingProperties;
import com.kaycheung.inventory_service.exception.domain.InventoryBusinessFailureException;
...
public class InboxEventWorker {
    ...
    public void processInboxEvents() {
        ...
        for (InboxEvent inboxEvent : inboxEvents) {
            try {
            ...
            } catch (IllegalArgumentException | InventoryBusinessFailureException ex) {
                ...
                // Transient failure: exponential backoff based on attempt count
