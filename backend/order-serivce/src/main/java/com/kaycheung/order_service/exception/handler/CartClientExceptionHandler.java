...
public class CartClientExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(CartClientExceptionHandler.class);

    @ExceptionHandler()
    public ResponseEntity<ApiErrorResponse> handleCartClientException(CartClientException ex, HttpServletRequest request) {
        log.error(
