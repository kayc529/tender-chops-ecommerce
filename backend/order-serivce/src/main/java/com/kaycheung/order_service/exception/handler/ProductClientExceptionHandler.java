...
public class ProductClientExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(ProductClientExceptionHandler.class);

    @ExceptionHandler()
    public ResponseEntity<ApiErrorResponse> handleProductClientException(ProductClientException ex, HttpServletRequest request) {
        log.error(
